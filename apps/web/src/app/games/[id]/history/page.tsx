...
import { useGame, useGameResults, useAuth } from '@/lib/hooks';
...
export default function GameHistoryPage() {
  ...
  const { data: resultsData, isLoading: resultsLoading } = useGameResults(gameId, {
    limit: 50,
  });
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {results.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-400 mb-6">이 게임으로 방을 만들고 플레이해보세요!</p>
            <button
              onClick={() => router.push(`/edit/${gameId}`)}
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-6 text-sm text-gray-700 mb-3">
            <span>평균 점수: <strong>{Math.round(result.averageScore)}점</strong></span>
          </div>
